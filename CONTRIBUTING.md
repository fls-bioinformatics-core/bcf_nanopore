...
The `bcf_nanopore` project has been developed specifically for use within the Bioinformatics
...
[GitHub issue tracker](https://github.com/fls-bioinformatics-core/bcf_nanopore/issues).

If you're unable to find an open issue addressing the problem then you can
[open a new one](https://github.com/fls-bioinformatics-core/bcf_nanopore/issues/new).
...
[GitHub pull request list](https://github.com/fls-bioinformatics-core/bcf_nanopore/pulls).
...
of code) and do not add anything substantial to the functionality of `bcf_nanopore` are
